puntosinteriores=function(m,n,Amod,Ax,Ay,e,b,C,tol,sigma,x,y,s,v,
  ...
  while(nF>tol && iter<itot){
    ...
    monitoreo_lista <- rbind(monitoreo_lista, c(iter,nF,nrcx1,nrb,nF3,nF4,obj,mu,alfa,cJ))
  ...
  monitoreo <- as.data.frame(monitoreo_lista)
  names(monitoreo) <- c("i", "|F|", "|rcx1|", "|rb|", "|f3|", "|f4|", "obj", "mu", "alfa", "cond")
  #print(monitoreo)
  
  list(nF,iter,x,y,lambda,mu, monitoreo)
