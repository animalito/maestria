...
No teníamos cómo funcionaba el NFS server: al utilizar dos carpetas con nombres distintos , es decir mirrorNFS y carpetaNodo olvidamos cerrar el loop del servidor NFS 
