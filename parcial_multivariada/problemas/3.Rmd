...
# podríamos hacer validacion cruzada  aunque dado que tenemos muchas 
observaciones creo mle funciona bien 
```
...
mkt_test$prob.1 <- predict(mod_3, type='response')
mkt_test$grupo.prob <- cut2(mkt_test$prob.1, g=20, levels.mean=TRUE)
