...
source('load.r')
multiplot(map_homicidios_r,map_robos_r,map_y_total_r)
```
...
#print(apsrtable(mod, mod_log, mod_poiss, mod_q_poiss, mod_poiss_log, mod_q_poiss_log), comment=F, include.rownames=F, size="small")
#print("Modelo Gaussiano, tasa de delito por cien mil habitantes")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, results='asis'}
#print("Modelo Gaussiano, logaritmo de tasa de delito por cien mil habitantes")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, results='asis'}
#print("Modelo Poisson, tasa de delito por cien mil habitantes")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, results='asis'}
#print("Modelo Poisson, logaritmo de tasa de delito por cien mil habitantes")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, results='asis'}
#print("Modelo Quasipoisson, tasa de delito por cien mil habitantes")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, results='asis'}
#print("Modelo Quasipoisson, logaritmo de tasa de delito por cien mil habitantes")
print(xtable(summary(mod_q_poiss_log)), comment=F, include.rownames=F, size="small")
```

$\pagebreak$

### Tabla de devianzas, aic, bic

```{r, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, results='asis'}
bic <- c(BIC(mod), BIC(mod_log), BIC(mod_poiss), BIC(mod_q_poiss), BIC(mod_poiss_log), BIC(mod_q_poiss_log))
aic  <- c(AIC(mod), AIC(mod_log), AIC(mod_poiss), AIC(mod_q_poiss), AIC(mod_poiss_log), AIC(mod_q_poiss_log))
devianza <- c(mod$deviance, mod_log$deviance, mod_poiss$deviance, mod_q_poiss$deviance, mod_poiss_log$deviance, mod_q_poiss_log$deviance)

tablita<- as.data.frame(rbind(bic, aic, devianza))

names(tablita) <- c('mod', 'mod_log', 'mod_poiss', 'mod_q_poiss', 'mod_poiss_log', 'mod_q_poiss_log')
print(xtable(tablita), comment=F)
```

## Analisis de supuestos

Por su devianza, los modelos que tenemos compitiendo son el gaussiano con transformación logarítmica, el poisson y el quasipoisson.

Presentamos los gráficos de el modelo gaussiano logarítmico.
...
Presentamos los gráficos de el modelo poisson.
...
Presentamos los gráficos de el modelo quasipoisson.
...
Los modelos con la transformación logarítmica en general no cumplieron adecuadamente con los supuestos del modelo. Al final, los 2 modelos que tenemos compitiendo por esta razón es el modelo poisson y el quasipoisson.
